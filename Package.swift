...
let package = Package(
    ...
    products: [
        .executable(name: "SwiftStyleFormatTool", targets: ["SwiftStyleFormatTool"])
    ],
    dependencies: [
    ...
    targets: [
        .executableTarget(
            name: "SwiftStyleFormatTool",
            dependencies: [
                .product(name: "ArgumentParser", package: "swift-argument-parser")
            ],
            resources: [
                .process("swiftstyle.swiftformat"),
                .process("swiftlint.yml"),
            ],
        ),

        .testTarget(
            name: "SwiftStyleFormatToolTests",
            dependencies: ["SwiftStyleFormatTool"],
        ),
